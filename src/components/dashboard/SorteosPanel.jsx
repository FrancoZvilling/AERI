                ...
                <AnimatePresence mode="wait">
                    ...
                    {phase === 'WAITING' && (
                        ...
                        >
                            ...
                            {/* Countdown Timer */}
                            <div className="flex items-center justify-center space-x-1.5 sm:space-x-3 md:space-x-4 mb-10">
                                <div className="flex flex-col">
                                    <div className="w-14 sm:w-16 md:w-20 h-16 sm:h-20 md:h-24 bg-gray-900 rounded-lg flex items-center justify-center shadow-inner border border-gray-800">
                                        <span className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold text-white">{time.d}</span>
                                    </div>
                                    <span className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 font-bold uppercase mt-2 text-center">DÍAS</span>
                                </div>
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-300 mt-2 sm:mt-5 md:mt-6 mb-auto">:</div>
                                <div className="flex flex-col">
                                    <div className="w-14 sm:w-16 md:w-20 h-16 sm:h-20 md:h-24 bg-gray-900 rounded-lg flex items-center justify-center shadow-inner border border-gray-800">
                                        <span className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold text-white">{time.h}</span>
                                    </div>
                                    <span className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 font-bold uppercase mt-2 text-center">HRS</span>
                                </div>
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-300 mt-2 sm:mt-5 md:mt-6 mb-auto">:</div>
                                <div className="flex flex-col">
                                    <div className="w-14 sm:w-16 md:w-20 h-16 sm:h-20 md:h-24 bg-gray-900 rounded-lg flex items-center justify-center shadow-inner border border-gray-800">
                                        <span className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold text-white">{time.m}</span>
                                    </div>
                                    <span className="text-[9px] sm:text-[10px] md:text-xs text-gray-500 font-bold uppercase mt-2 text-center">MIN</span>
                                </div>
                                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-300 mt-2 sm:mt-5 md:mt-6 mb-auto">:</div>
                                <div className="flex flex-col">
                                    <div className="w-14 sm:w-16 md:w-20 h-16 sm:h-20 md:h-24 bg-primary rounded-lg flex items-center justify-center shadow-lg border border-primary">
                                        <span className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold text-white">{time.s}</span>
                                    </div>
                                    <span className="text-[9px] sm:text-[10px] md:text-xs text-primary font-bold uppercase mt-2 text-center">SEG</span>
                                </div>
                            </div>
