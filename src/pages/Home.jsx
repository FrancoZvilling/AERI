    ...
    return (
        <div className="bg-gray-50 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-20">
                ...
                {/* --- SECCIÓN SECRETARÍA DE LA MUJER --- */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border-t-4 border-pink-500 overflow-hidden flex flex-col h-full hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <div className="p-6 flex-grow flex flex-col space-y-4">
                                ...
                                {/* Email */}
                                <a href="mailto:atencion144pba@ministeriodelasmujeres.gba.gob.ar" className="flex items-center bg-gray-50 hover:bg-gray-100 border border-gray-200 p-4 rounded-2xl transition-all mt-auto">
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-2xl transition-shadow duration-300 relative">
                            ...
                            <div className="p-8 pb-4 relative z-10 border-b border-gray-100">
                                ...
                                <p className="text-gray-600 font-medium">A mujeres y diversidades trabajadoras.</p>
                            </div>
                            ...
                            <div className="p-8 pt-6 flex-grow flex flex-col space-y-6 relative z-10">
                                ...
                                <div className="relative pl-6 border-l-2 border-[#39c3ef]">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 mt-3">
                                        <div className="flex items-center text-sm font-medium text-[#034c8c] bg-[#3dd1f2]/10 px-3 py-1.5 rounded-lg w-fit">
                                            <Clock className="w-4 h-4 mr-2" /> Mar y Jue de 10 a 12 hs
                                        </div>
                                        <a href="tel:02214248142" className="flex items-center text-sm font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg w-fit transition-colors">
                                            <Phone className="w-4 h-4 mr-2 text-[#1e6df9]" /> 221 424-8142 (Int. 842)
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="relative pl-6 border-l-2 border-[#1e6df9]">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 mt-3">
                                        <div className="flex items-center text-sm font-medium text-[#034c8c] bg-[#3dd1f2]/10 px-3 py-1.5 rounded-lg w-fit">
                                            <Clock className="w-4 h-4 mr-2" /> Miércoles de 10 a 12 hs
                                        </div>
                                        <a href="tel:02214294677" className="flex items-center text-sm font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg w-fit transition-colors">
                                            <Phone className="w-4 h-4 mr-2 text-[#1e6df9]" /> 221 429-4677
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="lg:col-span-2 bg-gradient-to-br from-[#f8fafc] to-[#e6f4f9] rounded-3xl shadow-lg border border-[#39c3ef]/20 p-8 flex flex-col md:flex-row gap-8 items-center overflow-hidden relative group">
                            ...
                            <div className="w-full md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
                                ...
                                <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-1 xl:col-span-2">
                                    ...
                                    <div className="space-y-2">
                                        <a href="mailto:equipogenerosecentral@gmail.com" className="flex items-center text-sm font-medium text-gray-600 hover:text-[#1e6df9] transition-colors break-all">
                                            <Mail className="w-4 h-4 mr-2 flex-shrink-0" /> equipogenerosecentral@gmail.com
                                        </a>
                                    </div>
                                </div>
                            </div>
